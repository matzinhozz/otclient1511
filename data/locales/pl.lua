locale = {
  ...
  translation = {
    ...
    ["Select creature to proceed."] = "Wybierz stworzenie, aby kontynuować.",
    ["Manage control buttons"] = "Zarządzaj przyciskami kontrolnymi",
    ["Open QuestLog Tracker"] = "Otwórz śledzenie QuestLog",
    ["Only Capture Game Window"] = "Tylko przechwyć okno gry",
    ["Keep Blacklog of the Screenshots of the Last 5 Seconds"] = "Zachowaj dziennik zrzutów ekranu z ostatnich 5 sekund",
    ["Enable Auto Screenshots"] = "Włącz automatyczne zrzuty ekranu",
    ["Select all events that sould trigger auto Screenshots:"] = "Wybierz wszystkie wydarzenia, które powinny wyzwalać automatyczne zrzuty ekranu:",
    ["Reset"] = "Resetuj",
    ...
    ["Open Boss Slots dialog"] = "Otwórz dialog slotów bossów",
    ["Open Bosstiary dialog"] = "Otwórz dialog bestiariusza",
    ["Bestiary Tracker"] = "Śledzenie bestiariusza",
    ["Open rewardWall"] = "Otwórz ścianę nagród",
    ["Customise Character"] = "Dostosuj postać",
    ["Prey Dialog"] = "Dialog łupu",
    ["Bosstiary Tracker"] = "Śledzenie Bestiariusza",
  ...
  ["You need at least 5 Prey Wildcards to select a specific creature."] = "Potrzebujesz co najmniej 5 Kart Łupu, aby wybrać konkretnego potwora.",
  ["You have: "] = "Masz: ",
  ["wildcards."] = "kart.",
  ["You don't have enough gold coins."] = "Nie masz wystarczająco złotych monet.",
  ["Required: "] = "Wymagane: ",
  ["gold coins."] = "złotych monet.",
  ["Bank: "] = "Bank: ",
  ["Backpack: "] = "Plecak: ",
  ["Total: "] = "Razem: ",
  ["You need at least 1 Prey Wildcard to use bonus reroll."] = "Potrzebujesz co najmniej 1 Kartę Łupu, aby użyć bonus reroll.",
  ["You need at least 1 Prey Wildcard to use automatic bonus reroll."] = "Potrzebujesz co najmniej 1 Kartę Łupu, aby użyć automatycznego bonus reroll.",
  ["You need at least 5 Prey Wildcards to lock prey."] = "Potrzebujesz co najmniej 5 Kart Łupu, aby zablokować łup.",
  }
}
