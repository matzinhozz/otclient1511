...
---@return ThingType[]
function g_things.getProficiencyThings() end

---@param itemId integer
---@return string
function g_things.getCyclopediaItemName(itemId) end
...
---@param raceId integer
function g_game.taskHuntingAction(slot, action, upgrade, raceId) end

---@return number
function g_game.getTaskHuntingPoints() end
...
---* FRAMEWORK_EDITOR
---@return integer
function Item:getProficiencyId() end
...
---@param maxWidth integer
---@return integer
function UIWidget:getWrappedLinesCount(maxWidth) end
