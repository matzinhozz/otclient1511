...
-- Compute sprite sheet frame top-left position
local function getFramePosition(index, frameWidth, frameHeight, columns)
    index = tonumber(index) or 0
    columns = columns or 1
    local col = index % columns
    local row = math.floor(index / columns)
    return string.format("%d %d", col * frameWidth, row * frameHeight)
end
