...
local function onDailyReward(data)
    ...
    -- Debug logi
    print("DEBUG: onDailyReward called with data:")
    print("  bonuses count:", data.bonuses and #data.bonuses or 0)
    if data.premiumRewards then
        print("  premiumRewards count:", #data.premiumRewards)
    end
    if data.freeRewards then
        print("  freeRewards count:", #data.freeRewards)
    end
...
local function onOpenRewardWall(bonusShrines, nextRewardTime, dayStreakDay, wasDailyRewardTaken, errorMessage, tokens,
    ...
    -- Debug logi
    print("DEBUG: onOpenRewardWall called with:")
    print("  bonusShrines:", bonusShrines)
    print("  dayStreakDay:", dayStreakDay)
    print("  wasDailyRewardTaken:", wasDailyRewardTaken)
    print("  tokens:", tokens)
    print("  timeLeft:", timeLeft)
    print("  dayStreakLevel:", dayStreakLevel)
